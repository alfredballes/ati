<?php
/*
 * The template for displaying delivery pages taxonomy.
 *
 * @package ATI
 ...
 */
 ...
 <section id="course-details">
	<div class="container w-80">
		<div class="row">
			<div class="col-12 col-xs-12 col-sm-12 col-md-12 col-lg-12 d-flex title-icon">
				<h1 style="text-align: center;"><?php echo get_queried_object()->name; ?> Courses</h1>
			</div>
		</div>
	</div>
